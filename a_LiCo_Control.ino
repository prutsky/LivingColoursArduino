...
unsigned char lamp0[9] = { 0x87, 0XB4, 0x6F, 0x14, 0x21, 0XD3, 0x9C, 0x8D, 0x11 }; // Lamp 1
unsigned char lamp1[9] = { 0x94, 0x05, 0x0F, 0XC6, 0x21, 0xD3, 0x9C, 0x8D, 0x11 }; // Lamp 2
...
//  Serial.println(SerBuf[0]);
  switch (SerBuf[0])
  {
    case 'q' :
    {
      ...
      Serial.println("al : turn lamp on.");
      Serial.println("nl-rrr-ggg-bbb : turn lamp on");      
      Serial.println("ul : turn lamp off");      
    ...
    case 'w' :
    {
      ...
      //livcol.setLampColourRGB(0, valB, valC, valD);
      //livcol.setLampColourRGB(1, valB, valC, valD);
    ...
    case 'a' :
    {
      ...
      if(valA == 3)
      {
//        livcol.turnLampOnHSV(0, 255, 100, 255);
        livcol.turnLampOnRGB(0, 255, 255, 000);
        delay(100);
        livcol.turnLampOnRGB(1, 255, 255, 000);
      }
      else
      {
        livcol.turnLampOnRGB(valA, 255, 255, 000);
      }
      lampOn = true;
